...
import random
from fMRI_dd_mb_general_yf_mb import fMRI_dd_mb_general_yf_mb
...
for ii in range(N):
    ...
    control_energy_mb, control_energy_dd, err_mb, err_dd = fMRI_dd_mb_general_yf_mb(subject_id)
