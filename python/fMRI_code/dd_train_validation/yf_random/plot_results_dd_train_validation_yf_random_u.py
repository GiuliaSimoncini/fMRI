...
# Title of the figure
plt.suptitle("yf random, same subjects used for train and validation")

# First subplot - Error
plt.subplot(2, 1, 1)
x = np.arange(nr)
width = 0.35
plt.bar(x - width / 2, mean_err_dd_train, width, label='data_driven train-validation u')
...
plt.subplot(2, 1, 2)
plt.bar(x - width/2, mean_control_energy_dd_train, width, label='data_driven train-validation u')
