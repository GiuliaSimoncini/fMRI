...
from fMRI_dd_train_validation_yf_train import fMRI_dd_train_validation_yf_train
...
for ii in range(Nvalidation):
    control_energy_dd, control_energy_dd_train, err_dd, err_dd_train = fMRI_dd_train_validation_yf_train(U_train, Yf_train, subject_ids_validation[ii])
...
# Title of the figure
plt.suptitle("yf train, same subjects used for train and validation")
